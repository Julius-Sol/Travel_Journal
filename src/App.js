...
function App() {
  const JournalEntryArray = data.map((Entry) => {
    return <JournalEntry key={Entry.idclea} entry={Entry}></JournalEntry>;
  });
  return (
    <div className="App">
      <header>
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="2em" height="2em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512">
          <path
            fill="currentColor"
